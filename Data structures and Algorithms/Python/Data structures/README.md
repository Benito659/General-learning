...
- * in *args is called the splat operator (informally), or more formally, iterable unpacking.
- It take all extra positional arguments passed to this function and pack them into a tuple.
- Types that can be unpacked with *
- List , Tuple, Set, Strings (each character is treated as an element), Any iterable (even generators!)
- Can be use In function definitions (packing)
- - *args, the * packs any number of positional arguments into a tuple.
- - ```
...
- - ``` def add(a, b, c):
    ...
    ```
- - ``` print_items(*[1,2], *[3,4])  # Unpacks the lists
        (1, 2, 3, 4)
    ```
